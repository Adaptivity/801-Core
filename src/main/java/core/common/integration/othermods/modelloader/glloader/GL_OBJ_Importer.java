...
public class GL_OBJ_Importer {
	...
	public GL_Mesh makeMeshObject(GL_OBJ_Reader objData) {
		List verts = objData.vertices;
		List txtrs = objData.textureCoords;
		List norms = objData.normals;
		List faces = objData.faces;
	 ...
	 * @return
	 */
	public GL_Triangle addTriangle(GL_Mesh obj, int groupNum, int triNum, Face face, List txtrs, List norms, int v1, int v2, int v3, int mtlID) {
	...
	public final GL_OBJ_Importer setDebugMode() {
		debug = true;
		return this;
	}
