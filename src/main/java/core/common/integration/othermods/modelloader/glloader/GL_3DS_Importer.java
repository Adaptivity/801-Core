...
public class GL_3DS_Importer
{
	...
	public final GL_Mesh load(String filename) {
	 ...
	 */
	public final GL_Mesh importFromStream(InputStream inStream) {
	 ...
	 * @return
	 */
	public final GL_Mesh makeMeshObject(ArrayList verts, ArrayList txtrs, ArrayList norms, ArrayList faces ) {
	 ...
	 * @return
	 */
	public final GL_Triangle addTriangle(GL_Mesh obj, Face face, ArrayList txtrs, ArrayList norms)
	{
